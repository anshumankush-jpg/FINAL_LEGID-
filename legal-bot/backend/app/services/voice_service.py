...
class VoiceService:
    ...
    async def text_to_speech(
        ...
        Args:
            ...
            voice: Voice name (e.g., "en-US-Neural2-D")
    ...
    async def get_available_voices(self) -> List[Dict[str, str]]:
        ...
        try:
            # Get voices for English
            voices_request = tts.ListVoicesRequest(language_code="en")
            ...
            for voice in response.voices[:10]:  # Limit to first 10 for performance
                voices.append({
                    "name": voice.name,
                    "language": voice.language_codes[0] if voice.language_codes else "en-US",
    ...
    def _mock_stt_response(self) -> Dict[str, Any]:
        ...
        return {
            "text": "This is a mock transcription. Please configure Google Cloud Speech-to-Text for actual functionality.",
            "confidence": 0.8
        }
